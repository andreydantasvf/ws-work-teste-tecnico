 ...
 * Placeholder for vehicle models management
 */
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Gerencie os modelos de carros do seu inventário
          </p>
        </div>
        ...
        <CardContent className="flex flex-col items-center justify-center text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground max-w-md">
              A página de gerenciamento de modelos está sendo desenvolvida. Em
              breve você poderá criar, editar e gerenciar modelos de veículos.
            </p>
          </div>
